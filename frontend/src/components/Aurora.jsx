/**
 * Aurora WebGL Background — Inspired by react-bits
 * Flowing northern-lights effect using OGL for lightweight WebGL rendering.
 * Colors default to JARVIS cyan/blue palette.
 */
...
export default function Aurora({
  colorStops = ['#00f0ff', '#003366', '#00f0ff'],
  amplitude = 1.0,
  blend = 0.5,
  speed = 1.0,
}) {
